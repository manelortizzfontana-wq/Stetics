...
const PRELOADED_ROUTINES = [
    {
        ...
        badge: 'Iniciación Estética',
        level: 'Principiante',
        daysPerWeek: 3,
        description: 'La base innegociable para empezar a construir un físico estético. Diseñada para aprender los patrones de movimiento esenciales, crear fuerza neuromuscular y activar todo el cuerpo de forma equilibrada.',
        guidelines: [
            ...
            'Técnica primero: El control excéntrico y la conexión mente-músculo son la clave estética.',
            'Sobrecarga progresiva: Intenta sumar 1 repetición o aumentar 1-2.5 kg cada semana.'
        ],
        exercises: [
    ...
    },
    {
        ...
        level: 'Intermedio',
        daysPerWeek: 4,
        description: 'Enfocada en esculpir la silueta en V que popularizó David Laid: hombros densos y laterales como cocos, espalda amplia y cintura compacta, complementado con fuerza en tren inferior.',
        guidelines: [
            'Estructura: 2 días de Torso y 2 días de Pierna (Lunes, Martes, Jueves y Viernes).',
            'Días pesados a 6-8 reps para reclutar fibras de alta intensidad; días ligeros a 10-15 reps para máximo bombeo.'
        ],
        exercises: [
    ...
    {
        id: 'routine_ppl_push',
        name: '⚡ Empuje / Tirón / Pierna (David Laid Aesthetic Era)',
        badge: 'David Laid Aesthetic',
        level: 'Intermedio / Avanzado',
        daysPerWeek: 3,
        description: 'La mítica división PPL. En este día de Empuje (Push) se busca reventar el pecho, deltoides anterior/lateral y tríceps con congestión extrema.',
        guidelines: [
            'Controla la bajada en 2 segundos en el press de banca y press inclinado.',
            'En las elevaciones laterales concéntrate en alejar las mancuernas hacia las paredes, no en subirlas rápido.'
        ],
        exercises: [
